...
High-performance **Spiking Neural Network (SNN)** library with SIMD optimization - CLI & SDK.
...
|---------|-------------|-------------|
| **LIF Neurons** | Leaky Integrate-and-Fire with configurable dynamics | Sub-ms updates |
| **STDP Learning** | Spike-Timing-Dependent Plasticity (unsupervised) | 26x faster w/ native |
| **Lateral Inhibition** | Winner-take-all competition | Sparse outputs |
| **SIMD Operations** | Loop-unrolled vector math | 5-54x speedup |
| **Rate/Temporal Encoding** | Multiple input encoding schemes | Flexible inputs |
| **Native Addon** | Optional C++ SIMD with SSE/AVX | 10-50x faster |
...
### Native SIMD Addon (Optional)

| Operation | Speedup |
|-----------|---------|
| LIF Updates | 16.7x |
| Synaptic Forward | 14.9x |
| STDP Learning | **26.3x** |
| Full Simulation | **18.4x** |
...
```bash
cd node_modules/spiking-neural
...
- [npm Package](https://www.npmjs.com/package/spiking-neural)
- [Meta-Cognition Examples](https://github.com/ruvnet/ruvector/tree/main/examples/meta-cognition-spiking-neural-network)
- [SNN Guide](https://github.com/ruvnet/ruvector/blob/main/examples/meta-cognition-spiking-neural-network/docs/SNN-GUIDE.md)
